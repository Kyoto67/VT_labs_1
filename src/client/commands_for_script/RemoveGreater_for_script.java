...
public class RemoveGreater_for_script extends AbstractCommand {
     ...
     */
    public RemoveGreater_for_script(String name, String description, CommandManager commandManager) {
    ...
    public boolean exec(String argument) throws IOException {
        try {
            ...
            System.out.println("Unreadable client.data. Skip remove_greater.");

...
public class GeneratingRandomInfo {
    ...
    /**
     * Запуск генерации коллекции из 20ти объектов Movie, заполненных полностью рандомными значениями.
     * @return Возвращает коллекцию PriorityQueue<Movie>
     * @throws IOException
     */
    public static PriorityQueue<Movie> run() throws IOException {
        PriorityQueue<Movie> collection = new PriorityQueue<>();
        for (int i=0; i<20; i++){

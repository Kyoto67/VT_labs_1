...
public class RemoveGreater_for_script extends AbstractCommand {
     ...
     */
    public RemoveGreater_for_script(String name, String description, ScriptManager scriptManager) {
    ...
    public boolean exec(String argument) throws IOException {
        try {
            ...
            System.out.println("Unreadable common.data. Skip remove_greater.");
